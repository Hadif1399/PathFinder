...
import { Search, X, Calendar, Award, Users, BookOpen, ExternalLink } from 'lucide-react';
import { preUniversityScholarships, PreUniversityScholarship } from '../data/preUniScholarships';
...
export default function PreUniScholarshipsPage() {
  ...
  const [selectedScholarship, setSelectedScholarship] = useState<PreUniversityScholarship | null>(null);

  const filters: FilterCategory[] = ['All', 'STEM', 'Merit', 'Need-Based', 'Sports', 'Arts'];

  const filteredScholarships = useMemo(() => {
    return preUniversityScholarships.filter((scholarship) => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto">
            Discover funding opportunities for your pre-university education. Filter by category or search to find the perfect scholarship for you.
          </p>
        </motion.div>
        ...
        >
          Showing {filteredScholarships.length} of {preUniversityScholarships.length} scholarships
        </motion.div>
